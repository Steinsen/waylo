 ...
 *
 * Monteras automatiskt i #turistbot (eller #waylo). Saknas elementet
 * väntar widgeten på DOMContentLoaded innan den ger upp.
 */
...
function montera() {
  const el =
    document.getElementById('turistbot') || document.getElementById('waylo');
